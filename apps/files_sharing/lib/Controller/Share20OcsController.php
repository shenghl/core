...
class Share20OcsController extends OCSController {
	...
	private function getCurrentUserFolder() {
		if ($this->currentUserFolder === null) {
			$this->currentUserFolder = $this->rootFolder->getUserFolder($this->userSession->getUser()->getUID());
		}
		return $this->currentUserFolder;
	}
	...
	protected function formatShare(IShare $share, $received = false) {
		...
		// not a user folder mount. Share node will be needed to retrive e.g.
